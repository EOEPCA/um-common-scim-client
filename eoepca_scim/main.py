...
def main():
    ...
    clientName="Test Statement Client"
    ...
    clientJSON = scim_client.registerClientSwStatement(clientName=clientName, grantTypes=grantTypes, redirectURIs=redirectURIs, logoutURI=logoutURI, responseTypes=responseTypes, scopes=scopes, sectorIdentifier=sectorIdentifier, token_endpoint_auth_method= ENDPOINT_AUTH_CLIENT_POST)
    ...
    # #Delete user
    # reply = scim_client.deleteUser(userEmail=userID)
    # print(reply)
